...
if __name__ == '__main__':
    with engine.connect() as conn:
        ...
        print(str(ins_user))  # INSERT INTO users (name, fullname) VALUES (:name, :fullname)
        ...
        ins_address = addresses.insert().values(email='jones@asd.asd', user_id=jones_id)
        conn.execute(ins_address)
        ins_address = addresses.insert().values(email='pupkin@asd.asd', user_id=pupkin_id)
        conn.execute(ins_address)
